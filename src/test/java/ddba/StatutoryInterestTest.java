...
public class StatutoryInterestTest {
	...
	public void shouldChooseProperInterestPercentageToCalculateInterest() {
		...
		double interestPer = interestRate.decideInterestPercentage(paymentDate);

		Assertions.assertThat(interestPer).isEqualTo(21.00);
	}

	@Test
	public void shouldChooseTheLatestUpdatedInterestPercentage() {
	...
	public void shouldReturnTwoInterestSinceInvoicePaidInTwoPartsBothOverDeadline() {
		...
		List<Output> outputs;
		outputs = InterestRate.InterestCalculator.calculateInterest(invoices, payments, null);
	...
	public void shouldNotBeAnyInterestIfPaymentWasOnTime() {
		...
		List<Output> outputs = InterestRate.InterestCalculator.calculateInterest(invoices, payments, null);
